...
var PandaDb = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Models_1.PandaUser.sync()];
                    case 2:
                        _a.sent();
                        console.log('Table: PandaUser sync');
                        return [4 /*yield*/, Models_1.PandaList.sync()];
                    case 3:
                        _a.sent();
                        console.log('Table: PandaList sync');
                        return [4 /*yield*/, Models_1.PandaListItem.sync()];
                    case 4:
                        _a.sent();
    ...
    PandaUser: Models_1.PandaUser,
    PandaList: Models_1.PandaList,
    PandaListItem: Models_1.PandaListItem
};
exports.default = PandaDb;
